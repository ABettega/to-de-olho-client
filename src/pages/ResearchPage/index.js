...
import { fetchCurrentSenate } from "../../redux/actions/senate";
...
const SearchPage = () => {
  ...
  const senado = useSelector(state => state.senate.data);

  useEffect(() => {
    dispatch(fetchCurrentSenate());
  }, []);
      ...
      {senado.map(senador => {
        return (
          <CardPolitico
            ...
            politician="/senador/"
            politicianName={senador.IdentificacaoParlamentar.NomeParlamentar}
            uf={senador.IdentificacaoParlamentar.UfParlamentar}
            backImage={senador.IdentificacaoParlamentar.UrlFotoParlamentar}
            siglaPartido={
              senador.IdentificacaoParlamentar.SiglaPartidoParlamentar
            }
          />
