        ...
        {(this.state.atual || this.state.historico) ?
          <div>
            ...
            <div className="presenca-sessoes-container">
              ...
              <RadialChart
                ...
                showLabels={true}
                data={[
                  { angle: atual.sessoes.total - atual.sessoes.presente, 
                    label: '' + atual.sessoes.total - atual.sessoes.presente, 
                    subLabel:'Ausência',
                  },
                  { angle: atual.sessoes.presente, 
                    label: '' + atual.sessoes.presente, 
                    subLabel:'Presença'},
                  ]}
              ...
              {/* <p className="legis-text">| {this.dateToShow(atual.legislatura.dataInicio)} - {this.dateToShow(atual.legislatura.dataFim)} |</p> */}
          ...
          <p><span>(Obstruções contam como 'presença' na votação)</span></p> */}
            ...
            {this.state.historico ?
              <div>
                <p className="legis-text">| {this.state.historico.legislaturas.map(legis => {
